...
from app.handlers import admin_router, coaches_router, dynamic_exercise_router, fallback_router, mesocycles_router, readiness_router, reserved_router
...
async def run() -> None:
    ...
    dp.include_router(readiness_router)
